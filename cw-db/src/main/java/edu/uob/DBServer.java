...
public class DBServer {
    ...
    */
    public String handleCommand(String command) {
        ...
        parser.dispatch(command);
        if (Parser.returnInfo==null){
            return "wrong";
        } else {
            return Parser.returnInfo;
        }
    }
...
//        Reader reader = new FileReader(fileToOpen);
        if (Files.exists(fileToOpen.toPath())){
            try (BufferedReader buffReader = new BufferedReader(new FileReader(fileToOpen))){
                ...
                System.out.println("Failed to read file"+ioException);
            }
        } else {
